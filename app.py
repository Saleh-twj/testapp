...
texts = {
    ...
    'Arabic': {
        ...
        <div class="learn-more-content" style="text-align: right; direction: rtl;">
            ...
            📊 معالجة البيانات
            يقوم النظام بمعالجة بيانات الأسهم التاريخية من خلال عدة خطوات:
            ...
            🤖 بنية النموذج الذكي
            ثلاثة نماذج مختلفة للشبكات العصبية متاحة:
            ...
            🎯 عملية التدريب
            تشمل عملية التدريب الخطوات التالية:
            ...
            📈 التنبؤ والتحليل
            يوفر النظام تنبؤات وتحليلات شاملة:
   ...
   # Simple and safe normalization for yfinance data
    ...
    with col_demo1:
        ...
        <div style='text-align: center; padding: 1.5rem;'>
            ...
            {t['select_stock']}
            <p style='color: #b0b0b0;'>{t['select_stock_desc']}
        </div>
        """, unsafe_allow_html=True)
    ...
    with col_demo2:
        ...
        <div style='text-align: center; padding: 1.5rem;'>
            <div style='font-size: 3rem; margin-bottom: 1rem;'>🤖</div>
            {t['ai_training']}
            <p style='color: #b0b0b0;'>{t['ai_training_desc']}
        </div>
        """, unsafe_allow_html=True)
    ...
    with col_demo3:
        ...
        <div style='text-align: center; padding: 1.5rem;'>
            <div style='font-size: 3rem; margin-bottom: 1rem;'>🔮</div>
            {t['get_predictions']}
            <p style='color: #b0b0b0;'>{t['get_predictions_desc']}
        </div>
        """, unsafe_allow_html=True)
